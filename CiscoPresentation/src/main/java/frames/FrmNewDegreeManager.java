 ...
 * @author adane
 */
public class FrmNewDegreeManager extends javax.swing.JFrame {
     ...
     */
    public FrmNewDegreeManager(IDegreeBO degreeBO, DegreeDTO degreeDTO) {
        initComponents();
    ...
    public void loadFrame() {
        ...
        spTime.setModel(new SpinnerNumberModel(1, 1, 10, 1));
    ...
    private void initComponents() {
        ...
        LbNewDegree = new javax.swing.JLabel();
        ...
        LbNewDegree.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        LbNewDegree.setText("New Degree");
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
         try {
            ...
            degreeDTO.setName(DegName);
            degreeDTO.setTimeLimit(DegTime);
            

            degreeBO.saveDegree(degreeDTO);

            JOptionPane.showMessageDialog(this, "Carrera guardado exitosamente.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
    ...
    private javax.swing.JLabel LbNewDegree;
