 ...
 * @author aleja
 */
public class FrmAvailableSoftware extends javax.swing.JFrame {
     ...
     */
    public FrmAvailableSoftware(IComputerSoftwareBO computerSoftwareBO, ISoftwareBO softwareBO, ComputerDTO computerDTO) {
        initComponents();
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmAvailableSoftware.class.getName()).log(Level.SEVERE, null, ex);
        }
